...
// ─── Shared state ─────────────────────────────────────────────
export let customPlanogram = { shelves: [] };
export let allFetchedPlanograms = [];
...
export async function loadPlanogramFiles() {
...
export function renderPlanogramDropdown() {
    const sel = document.getElementById('planogramFileSelect');
...
export async function saveProductsToMongo(products) {
    try {
...
export async function loadProductsFromMongo(pogState, renderCatalogFn) {
