...
window.selectStore = function selectStore(id, name) {
...
window.filterBrands = function filterBrands(q) {
...
window.selectBrand = function selectBrand(name, color) {
...
window.selectManualBrand = function selectManualBrand() {
...
window.selectShelf = function selectShelf(id, name) {
...
window.toggleRow = function toggleRow(index, checkbox) {
...
// ─── Submit ──────────────────────────────────────────────────
window.submitContract = async function submitContract() {
